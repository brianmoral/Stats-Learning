...
```{r chunk25}
Auto <- read.table("~/Desktop/Fall-2022/Stats-Learning/ALL-CSV-FILES/Auto.data")
View(Auto)
head(Auto)
```
...
```{r chunk26}
Auto <- read.table("~/Desktop/Fall-2022/Stats-Learning/ALL-CSV-FILES/Auto.data", header = T, na.strings = "?", stringsAsFactors = T)
View(Auto)
```
...
```{r chunk27}
Auto <- read.csv("~/Desktop/Fall-2022/Stats-Learning/ALL-CSV-FILES/Auto.csv", na.strings = "?", stringsAsFactors = T)
View(Auto)
dim(Auto)
Auto[1:4, ]
```
